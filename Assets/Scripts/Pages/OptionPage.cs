...
public class OptionPage: PageContatiner
{
  ...
  public OptionPage ()
  {
	...
	_controlLabel.scale = 1.25f;
	_instructions = new FLabel("Franchise", "Instructions: ");
	_instructions.scale = 1.25f;
	...
	_controlLabel.y = -Futile.screen.halfHeight + 150.0f;
    ...
    _padControlButton.x = Futile.screen.halfWidth - 180.0f;
	...
	_instrSteps.x = Futile.screen.halfWidth - 250.0f;
	_instrSteps.y = Futile.screen.halfHeight - 150.0f;
